...
/**
 * Test of CS 143 Assignment 3 by Martin Hock
 * Edits by David Anderson (5/17/2023)
 *
 * You may only use this code as a student of David Anderson, CS 143 at TCC, Spring 2023
 */
public class DLListTest {
	...
	public static void main(String[] args) {
		System.out.println(
				"=======================================================================================\n"+
						"Tester for CS 143 Assignment 4: DLList\n"+
						"=======================================================================================\n"+
		...
		try {
			...
			if (verifyRev < 182) {
				System.out.println(
						"Notice there were some errors in your code. It's possible that after fixing those errors, problems with your descendingIterator() could be revealed.");
			}
			...
			if (verifySize < 182 && verifyRev == 182) {
				System.out.println(
						"Notice there were some errors in your code. It's possible that after fixing those errors, problems with your size() method could be revealed.");
			} else if (verifySize < 182) {
				System.out.println(
						"Additionally, problems with size() method could be revealed.");
			}
			...
			if(iterScore != 20) {
				System.out.println("\t* The tester found issues with your descending iterator! See output above.");
			}
			else {
				System.out.println("\t* descending iterator looks good!");
			}
			
			if(sizeScore != 20) {
				System.out.println("\t* The tester found issues with your size method! See output above.");
			}
			else {
				System.out.println("\t* size method looks good!");
			}
			
			if(getScore != 10) {
				System.out.println("\t* The tester found issues with your get method speedup! See output above.");
			}
			else {
				System.out.println("\t* get method speedup looks good!");
			}
			...
			if(revScore != 25) {
				System.out.println("\t* The tester found issues with your reverse method! See output above.");
			}
			else {
				System.out.println("\t* reverse method looks good!");
			}
			if(addScore != 25) {
				System.out.println("\t* The tester found issues with your add method! See output above.");
			}
			else {
				System.out.println("\t* add method looks good!");
			}
			System.out.println("\t* Extra credit not tested! See assignment sheet for extra credit description.");
