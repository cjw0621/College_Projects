...
/**
 * Test program for CS 143 Assignment 5 (Version of 5/30/2023)
 * Original tester by Martin Hock
 * Edits by David Anderson (Spring 2023)
 * 
 * You may only use this program as a student of David Anderson, CS 143 Spring
 * 2023. You may not give this program to any other people or companies (aside
...
public class WeatherDataTest {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
		...
		try {
			...
			System.out.println("=======================================================================================");
			System.out.println("\nTest Results (not an official score):");
