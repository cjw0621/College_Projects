...
/**
 * Test of CS 143 Assignment 3 by Martin Hock (Version of 11:00am PM 5/2/2023)
 *
 *
...
public class RecursionIntroTest {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException {
		System.out.println(
				"=======================================================================================\n"+
						"Tester for CS 143 Assignment 3: Recursion\n"+
						"=======================================================================================\n"+
						...
						"* Note that the tester also checks your code to make sure that the syntax rules for the\n\t"+
						" assignment are followed (such as no for or while loops). Please see the assignment \n\t"+
						" description for a complete list of which Java constructs should be avoided for this \n\t"+
						" assignment.\n"+
						"=======================================================================================\n"
		);
		String source = null;
		...
		System.out.println(
				"If the tester does not terminate, your program didn't get to the end (possibly taking an extremely long or infinite amount of time)!\n");
